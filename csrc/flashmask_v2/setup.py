...
FORCE_BUILD = os.getenv("FLASH_MASK_V2_FORCE_BUILD", "FALSE") == "TRUE"
SKIP_CUDA_BUILD = os.getenv("FLASH_MASK_V2_SKIP_CUDA_BUILD", "FALSE") == "TRUE"
# For CI, we want the option to build with C++11 ABI since the nvcr images use C++11 ABI
FORCE_CXX11_ABI = os.getenv("FLASH_MASK_V2_FORCE_CXX11_ABI", "FALSE") == "TRUE"

DISABLE_BACKWARD = os.getenv("FLASH_MASK_V2_DISABLE_BACKWARD", "FALSE") == "TRUE"
DISABLE_SPLIT = os.getenv("FLASH_MASK_V2_DISABLE_SPLIT", "FALSE") == "TRUE"
DISABLE_PAGEDKV = os.getenv("FLASH_MASK_V2_DISABLE_PAGEDKV", "FALSE") == "TRUE"
DISABLE_APPENDKV = os.getenv("FLASH_MASK_V2_DISABLE_APPENDKV", "FALSE") == "TRUE"
DISABLE_LOCAL = os.getenv("FLASH_MASK_V2_DISABLE_LOCAL", "FALSE") == "TRUE"
DISABLE_SOFTCAP = os.getenv("FLASH_MASK_V2_DISABLE_SOFTCAP", "FALSE") == "TRUE"
DISABLE_PACKGQA = os.getenv("FLASH_MASK_V2_DISABLE_PACKGQA", "FALSE") == "TRUE"
DISABLE_FP16 = os.getenv("FLASH_MASK_V2_DISABLE_FP16", "FALSE") == "TRUE"
DISABLE_FP8 = os.getenv("FLASH_MASK_V2_DISABLE_FP8", "FALSE") == "TRUE"
DISABLE_VARLEN = os.getenv("FLASH_MASK_V2_DISABLE_VARLEN", "FALSE") == "TRUE"
DISABLE_CLUSTER = os.getenv("FLASH_MASK_V2_DISABLE_CLUSTER", "FALSE") == "TRUE"
DISABLE_HDIM64 = os.getenv("FLASH_MASK_V2_DISABLE_HDIM64", "FALSE") == "TRUE"
DISABLE_HDIM96 = os.getenv("FLASH_MASK_V2_DISABLE_HDIM96", "FALSE") == "TRUE"
DISABLE_HDIM128 = os.getenv("FLASH_MASK_V2_DISABLE_HDIM128", "FALSE") == "TRUE"
DISABLE_HDIM192 = os.getenv("FLASH_MASK_V2_DISABLE_HDIM192", "FALSE") == "TRUE"
DISABLE_HDIM256 = os.getenv("FLASH_MASK_V2_DISABLE_HDIM256", "FALSE") == "TRUE"
DISABLE_SM8x = os.getenv("FLASH_MASK_V2_DISABLE_SM80", "FALSE") == "TRUE"
DISABLE_SM8X = os.getenv("FLASH_MASK_V2_DISABLE_SM80", "FALSE") == "TRUE"

ENABLE_VCOLMAJOR = os.getenv("FLASH_MASK_V2_ENABLE_VCOLMAJOR", "FALSE") == "TRUE"

DISABLE_HDIMDIFF64 = os.getenv("FLASH_MASK_V2_DISABLE_HDIMDIFF64", "FALSE") == "TRUE"
DISABLE_HDIMDIFF192 = os.getenv("FLASH_MASK_V2_DISABLE_HDIMDIFF192", "FALSE") == "TRUE"
...
def create_build_config_file():
    CONFIG = {
        "build_flags": {
            "FLASHMASK_V2_DISABLE_BACKWARD": DISABLE_BACKWARD,
            ...
            "FLASHMASK_V2_DISABLE_SM8X": DISABLE_SM8X,
            "FLASHMASK_V2_ENABLE_VCOLMAJOR": ENABLE_VCOLMAJOR,
            "FLASH_MASK_V2_DISABLE_HDIMDIFF64": DISABLE_HDIMDIFF64,
            "FLASH_MASK_V2_DISABLE_HDIMDIFF192": DISABLE_HDIMDIFF192,
        }
    }
...
def is_offline_build() -> bool:
    ...
    may set `FLASH_MASK_V2_OFFLINE_BUILD` in the build environment to prevent any attempts at downloading
    ...
    """
    return check_env_flag("FLASH_MASK_V2_OFFLINE_BUILD", "")


# Copied from https://github.com/triton-lang/triton/blob/main/python/setup.py
def get_flashattn_cache_path():
    user_home = os.getenv("FLASH_MASK_V2_HOME")
    if not user_home:
...
if not SKIP_CUDA_BUILD:
    ...
    feature_args = (
        []
        + (["-DFLASHMASK_V2_DISABLE_BACKWARD"   ,"-DFLASHATTENTION_DISABLE_BACKWARD"] if DISABLE_BACKWARD else [])
        + (["-DFLASHMASK_V2_DISABLE_PAGEDKV"    ,"-DFLASHATTENTION_DISABLE_PAGEDKV"] if DISABLE_PAGEDKV else [])
        + (["-DFLASHMASK_V2_DISABLE_SPLIT"      ,"-DFLASHATTENTION_DISABLE_SPLIT"] if DISABLE_SPLIT else [])
        + (["-DFLASHMASK_V2_DISABLE_APPENDKV"   ,"-DFLASHATTENTION_DISABLE_APPENDKV"] if DISABLE_APPENDKV else [])
        + (["-DFLASHMASK_V2_DISABLE_LOCAL"      ,"-DFLASHATTENTION_DISABLE_LOCAL"] if DISABLE_LOCAL else [])
        + (["-DFLASHMASK_V2_DISABLE_SOFTCAP"    ,"-DFLASHATTENTION_DISABLE_SOFTCAP"] if DISABLE_SOFTCAP else [])
        + (["-DFLASHMASK_V2_DISABLE_PACKGQA"    ,"-DFLASHATTENTION_DISABLE_PACKGQA"] if DISABLE_PACKGQA else [])
        + (["-DFLASHMASK_V2_DISABLE_FP16"       ,"-DFLASHATTENTION_DISABLE_FP16"] if DISABLE_FP16 else [])
        + (["-DFLASHMASK_V2_DISABLE_FP8"        ,"-DFLASHATTENTION_DISABLE_FP8"] if DISABLE_FP8 else [])
        + (["-DFLASHMASK_V2_DISABLE_VARLEN"     ,"-DFLASHATTENTION_DISABLE_VARLEN"] if DISABLE_VARLEN else [])
        + (["-DFLASHMASK_V2_DISABLE_CLUSTER"    ,"-DFLASHATTENTION_DISABLE_CLUSTER"] if DISABLE_CLUSTER else [])
        + (["-DFLASHMASK_V2_DISABLE_HDIM64"     ,"-DFLASHATTENTION_DISABLE_HDIM64"] if DISABLE_HDIM64 else [])
        + (["-DFLASHMASK_V2_DISABLE_HDIM96"     ,"-DFLASHATTENTION_DISABLE_HDIM96"] if DISABLE_HDIM96 else [])
        + (["-DFLASHMASK_V2_DISABLE_HDIM128"    ,"-DFLASHATTENTION_DISABLE_HDIM128"] if DISABLE_HDIM128 else [])
        + (["-DFLASHMASK_V2_DISABLE_HDIM192"    ,"-DFLASHATTENTION_DISABLE_HDIM192"] if DISABLE_HDIM192 else [])
        + (["-DFLASHMASK_V2_DISABLE_HDIM256"    ,"-DFLASHATTENTION_DISABLE_HDIM256"] if DISABLE_HDIM256 else [])
        + (["-DFLASHMASK_V2_DISABLE_SM8x"       ,"-DFLASHATTENTION_DISABLE_SM8x"] if DISABLE_SM8x else [])
        + (["-DFLASHMASK_V2_DISABLE_SM8X"       ,"-DFLASHATTENTION_DISABLE_SM8X"] if DISABLE_SM8X else [])
        + (["-DFLASHMASK_V2_ENABLE_VCOLMAJOR"   ,"-DFLASHATTENTION_ENABLE_VCOLMAJOR"] if ENABLE_VCOLMAJOR else [])
        + (["-DFLASHMASK_V2_DISABLE_HDIMDIFF64" ,"-DFLASHATTENTION_DISABLE_HDIMDIFF64"] if DISABLE_HDIMDIFF64 else [])
        + (["-DFLASHMASK_V2_DISABLE_HDIMDIFF192","-DFLASHATTENTION_DISABLE_HDIMDIFF192"] if DISABLE_HDIMDIFF192 else [])
    )
    ...
    sources = (
        [flash_api_source,"flash_api_cuda.cu"]
