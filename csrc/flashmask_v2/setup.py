...
if not SKIP_CUDA_BUILD:
    ...
    if bare_metal_version < Version("12.3"):
        raise RuntimeError("FlashMask-2 is only supported on CUDA 12.3 and above")
    ...
    sources=["flash_api.cu", "flash_api_torch.cpp", "instantiations/flash_fwd_hdim64_bf16_sm90.cu", "instantiations/flash_fwd_hdim128_bf16_sm90.cu", 
             "instantiations/flash_fwd_hdim256_bf16_sm90.cu", "instantiations/flash_bwd_hdim64_bf16_sm90.cu", "instantiations/flash_bwd_hdim64_bf16_determ_sm90.cu", 
             "instantiations/flash_bwd_hdim64_bf16_causal_sm90.cu", "instantiations/flash_bwd_hdim64_bf16_causal_determ_sm90.cu", "instantiations/flash_bwd_hdim128_bf16_sm90.cu", 
             "instantiations/flash_bwd_hdim128_bf16_determ_sm90.cu", "instantiations/flash_bwd_hdim128_bf16_causal_sm90.cu", "instantiations/flash_bwd_hdim128_bf16_causal_determ_sm90.cu", 
             "instantiations/flash_bwd_hdim256_bf16_sm90.cu", "instantiations/flash_bwd_hdim256_bf16_determ_sm90.cu", "instantiations/flash_bwd_hdim256_bf16_causal_sm90.cu", 
             "instantiations/flash_bwd_hdim256_bf16_causal_determ_sm90.cu", "flash_prepare_scheduler.cu"]
    print(f"{sources =}")
    nvcc_flags = [
        "-O3",
        "-std=c++17",
...
setup(
    ...
    py_modules=["flash_attn_interface", "flashmask_config"],
    description="FlashMask-2",
    classifiers=[
